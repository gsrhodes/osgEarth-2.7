...
#define VP_MIN_DURATION      30.0     // minimum fly time. GAJ was 2.0
#define VP_METERS_PER_SECOND 125.0  // fly speed GAJ was 2500
#define VP_MAX_DURATION      240.0     // maximum fly time. GAJ was 2.0
